...
function Necklaces() {
  ...
  const getProducts = async () => {
    try {
      // setIsLoading(true)
      let response = await fetch(`http://localhost:3001/products/getProductByCategory/Necklaces`,
        {
          method: "GET",
          headers: {
  ...
  const categoryOptions = ['Earrings', 'Watches', 'Bracelets', 'Necklaces'];
        ...
        <Row>
          <Col>
            <div className="products-intro">
              <h1>Necklaces</h1>
              <p>Adorn your elegance with necklaces that reflect your inner light.</p>
            </div>
          </Col>
        </Row>
